...
-->
	...
	<TR>
		<TD>
			<FORM method="post" action="User/User_registSuccess">
				<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
					<TBODY>
						...
						<TR>
							...
							<TD colspan="2">
								...
								<DIV align=center style=" color:#B0C4DE ">
									Please fill the following information, "<SPAN
										style="color:#FF0000">*</SPAN>" is necessary.
								</DIV>
								<BR></TD>
							<TD width=33%>&nbsp;</TD>
						</TR>
						...
						<TR>
							<TD style="color:red">Author ID</TD>
							<TD width="26%"><input name="user.userid" type="text"
								maxlength="20" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')"> &nbsp;<SPAN style="color:#FF0000">*</SPAN>
							</TD>
						</TR>
						<TR>
						...
						<TR>
							<TD style="color:red">Confirm Psw.</TD>
							<TD width="26%"><input name="user.password_Confirm"
								type="password" maxlength="20" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')"> &nbsp;<SPAN
						...
						<TR>
							...
							<TD width="26%"><input name="user.email" type="text"
								maxlength="48" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')"> &nbsp; <SPAN style="color:#FF0000">*</SPAN>
							</TD>
						</TR>
						<TR>
							<TD style="color:red">Sex</TD>
